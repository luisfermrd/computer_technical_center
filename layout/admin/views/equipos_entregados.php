...
//Equipos entregados
$query8 = $pdo->prepare("SELECT * FROM equipo WHERE reparado = 'SI' && entregado = 'SI'");
$query8->execute();
$equipos_entregados = $query8->fetchAll(PDO::FETCH_ASSOC);
...
<section class="home">
    <div class="text">Equipos entregados</div>
    <?php
        include("../../fragment_views/entregados.php");
    ?>
</section>
