...
$query = $pdo->prepare("SELECT * FROM equipo WHERE reparando = 'NO' && entregado = 'NO'");
$query->execute();
...
<section class="home">
    <div class="text">Equipos disponibles para reparar</div>
    <?php
        include("../../fragment_views/reparar.php");
    ?>
</section>
