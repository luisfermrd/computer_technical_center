...
//Equipos reparados
$query6 = $pdo->prepare("SELECT * FROM equipo WHERE reparado = 'SI' && entregado = 'NO'");
$query6->execute();
$equipos_reparados = $query6->fetchAll(PDO::FETCH_ASSOC);
...
<section class="home">
    <div class="text">Equipos reparados</div>
    <?php
        include("../../fragment_views/reparados.php"); 
    ?>
</section>
